...
var AppComponent = (function () {
    ...
    AppComponent.prototype.roleUser = function () {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__pages_profile_nurse_profile_nurse_component__ = __webpack_require__("../../../../../src/app/pages/profile-nurse/profile-nurse.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__pages_requests_page_users_request_page_users_component__ = __webpack_require__("../../../../../src/app/pages/requests-page-users/request-page.users.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__services_request_users_service__ = __webpack_require__("../../../../../src/app/services/request.users.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29__pages_profile_patient_edit_profile_patient_edit_component__ = __webpack_require__("../../../../../src/app/pages/profile-patient-edit/profile-patient-edit.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_30__pages_create_request_create_request_component__ = __webpack_require__("../../../../../src/app/pages/create-request/create-request.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_31__pages_profile_nurse_edit_profile_nurse_edit_component__ = __webpack_require__("../../../../../src/app/pages/profile-nurse-edit/profile-nurse-edit.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ROUTES = [
    ...
    { path: 'requestsUsers', component: __WEBPACK_IMPORTED_MODULE_27__pages_requests_page_users_request_page_users_component__["a" /* RequestPageUsersComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_11__common_auth_service__["a" /* AuthService */]], },
    ...
    { path: 'profileNurse', component: __WEBPACK_IMPORTED_MODULE_26__pages_profile_nurse_profile_nurse_component__["a" /* ProfileNurse */] },
    { path: 'editPatient', component: __WEBPACK_IMPORTED_MODULE_29__pages_profile_patient_edit_profile_patient_edit_component__["a" /* EditPatientComponent */] },
    { path: 'createRequest', component: __WEBPACK_IMPORTED_MODULE_30__pages_create_request_create_request_component__["a" /* CreateRequest */] },
    { path: 'editNurse', component: __WEBPACK_IMPORTED_MODULE_31__pages_profile_nurse_edit_profile_nurse_edit_component__["a" /* EditNurseComponent */] },
...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["M" /* NgModule */])({
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_27__pages_requests_page_users_request_page_users_component__["a" /* RequestPageUsersComponent */],
            ...
            __WEBPACK_IMPORTED_MODULE_26__pages_profile_nurse_profile_nurse_component__["a" /* ProfileNurse */],
            __WEBPACK_IMPORTED_MODULE_19__pages_request_view_request_view_component__["a" /* RequestViewPageComponent */],
            __WEBPACK_IMPORTED_MODULE_18__pages_nursing_personal_byservice_nursing_personal_byservice_component__["a" /* NursingPersonalByServiceComponent */],
            __WEBPACK_IMPORTED_MODULE_30__pages_create_request_create_request_component__["a" /* CreateRequest */],
            __WEBPACK_IMPORTED_MODULE_29__pages_profile_patient_edit_profile_patient_edit_component__["a" /* EditPatientComponent */],
            __WEBPACK_IMPORTED_MODULE_31__pages_profile_nurse_edit_profile_nurse_edit_component__["a" /* EditNurseComponent */]
        ],
        imports: [
        ...
        providers: [
            ...
            __WEBPACK_IMPORTED_MODULE_28__services_request_users_service__["a" /* RequestUsersService */],
        ],
...
/***/ "../../../../../src/app/pages/create-request/create-request.component.css":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../../../../src/app/pages/create-request/create-request.component.html":
/***/ (function(module, exports) {

module.exports = "<br>\n<br>\n<div class=\"container\">\n    <br>\n    <div id=\"centerbrand\">\n\n        <img id=\"brand\"  src=\"/assets/brand/brand.png\" width=\"170\" height=\"80\">\n    </div>\n\n    <h2 class=\"text-center\">Perfil</h2>\n    <br>\n        <tr *ngIf=\"profileNurse\">\n\n        <div>\n            <label>Username</label>\n            <p *ngIf=\"profileNurse\">{{profileNurse.username}}</p>\n            <label>Nombre</label>\n            <h1>{{profileNurse.firstname}}</h1>\n            <label>Apellido</label>\n            <h1>{{profileNurse.lastname}}</h1>\n            <label> Correo</label>\n            <h1>{{profileNurse.email}}</h1>\n            <label>Edad</label>\n            <h1>{{profileNurse.age}}</h1>\n            <label>Experience</label>\n            <h1>{{profileNurse.experience}}</h1>\n        </div>\n    \n        </tr>\n    <form [formGroup]=\"createRequestForm\" (ngSubmit)=\"createService()\" novalidate>\n        <br><br><br>\n        <h1 class=\"text-center\">Descripcion</h1>\n        <input class=\"form-control\" id=\"description\" formControlName=\"description\" type=\"text\" size=\"40\" maxlength=\"80\" value=\"Describa aqui el servicio que requiere\" name=\"Descripcion\">\n        <br><br>\n        Fecha del servicio\n        <input type=\"date\" id=\"dateService\" formControlName=\"dateService\" class=\"form-control\" name=\"dateService\">\n        <br><br><br>\n        <button type=\"submit\" class=\"btn btn-success\" >Solicitar Servicio</button>\n    </form>\n</div>\n"

/***/ }),

/***/ "../../../../../src/app/pages/create-request/create-request.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var CreateRequest = (function () {
    function CreateRequest(requestService, userService, formBuilder, router) {
        this.requestService = requestService;
        this.userService = userService;
        this.formBuilder = formBuilder;
        this.router = router;
    }
    CreateRequest.prototype.ngOnInit = function () {
        var _this = this;
        var data = sessionStorage.getItem("nurseUser");
        this.userService.profileNurse(data).subscribe(function (todosResponse) {
            console.log(todosResponse);
            _this.profileNurse = todosResponse;
        });
    ...
    CreateRequest.prototype.createService = function () {
...
CreateRequest = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["o" /* Component */])({
        ...
        template: __webpack_require__("../../../../../src/app/pages/create-request/create-request.component.html"),
        styles: [__webpack_require__("../../../../../src/app/pages/create-request/create-request.component.css")]
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_2__services_request_service__["a" /* RequestService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__services_request_service__["a" /* RequestService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_3__services_users_service__["a" /* UsersService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__services_users_service__["a" /* UsersService */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_1__angular_forms__["a" /* FormBuilder */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_forms__["a" /* FormBuilder */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_4__angular_router__["a" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__angular_router__["a" /* Router */]) === "function" && _d || Object])
], CreateRequest);
...
var NursingPersonalByServiceComponent = (function () {
    function NursingPersonalByServiceComponent(nursingservicesService, router) {
    ...
    NursingPersonalByServiceComponent.prototype.showProfile = function (username) {
...
NursingPersonalByServiceComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__services_nursingservices_service__["a" /* NursingservicesService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__services_nursingservices_service__["a" /* NursingservicesService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2__angular_router__["a" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__angular_router__["a" /* Router */]) === "function" && _b || Object])
...
/***/ "../../../../../src/app/pages/profile-nurse-edit/profile-nurse-edit.component.css":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../../../../src/app/pages/profile-nurse-edit/profile-nurse-edit.component.html":
/***/ (function(module, exports) {

module.exports = "<br>\n<br>\n<div class=\"container\">\n    <br>\n    <div id=\"centerbrand\">\n\n        <img id=\"brand\"  src=\"/assets/brand/brand.png\" width=\"170\" height=\"80\">\n    </div>\n\n    <h2 class=\"text-center\">Perfil</h2>\n    <br>\n\n\n    <form [formGroup]=\"editNurseForm\" (ngSubmit)=\"editNurse()\" novalidate>\n        <tr *ngIf=\"profileNurse\">\n\n            <div>\n\n                <div class=\"form-group\">\n                    <label><h4>Username:</h4> </label>\n                    <p *ngIf=\"profileNurse\">{{profileNurse.username}}</p>\n                </div>\n                <div class=\"form-group\">\n                    <label> <h4>Nombre:</h4></label>\n                    <input id=\"firstname\" formControlName=\"firstname\" class=\"form-control\" value=\"{{profileNurse.firstname}}\"> <br>\n                </div>\n                <div class=\"form-group\">\n                    <label><h4>Apellido:</h4></label>\n                    <input id=\"lastname\" formControlName=\"lastname\" class=\"form-control\" value=\"{{profileNurse.lastname}}\"> <br>\n                </div>\n\n                <div class=\"form-group\">\n                    <label><h4>Password:</h4></label>\n                    <input id=\"password\" formControlName=\"password\"  class=\"form-control\" type=\"password\" value=\"{{profileNurse.password}}\"> <br>\n                </div>\n                <div class=\"form-group\">\n                    <label> <h4>Correo:</h4></label>\n                    <input id=\"email\" formControlName=\"email\" class=\"form-control\" value=\"{{profileNurse.email}}\"> <br>\n                </div>\n                <div class=\"form-group\">\n                    <label><h4>Edad:</h4></label>\n                    <input id=\"age\" formControlName=\"age\" class=\"form-control\" value=\"{{profileNurse.age}}\"> <br>\n                </div>\n\n                <div class=\"form-group\">\n                    <label><h4>Experience:</h4></label>\n                    <input id=\"creditCVV\" formControlName=\"experience\" class=\"form-control\" value=\"{{profileNurse.experience}}\"> <br>\n                </div>\n            </div>\n\n        </tr>\n        <button type=\"submit\" class=\"btn btn-success\" >Guardar</button>\n    </form>\n\n</div>\n\n\n"

/***/ }),

/***/ "../../../../../src/app/pages/profile-nurse-edit/profile-nurse-edit.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return EditNurseComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_forms__ = __webpack_require__("../../../forms/@angular/forms.es5.js");
...
var EditNurseComponent = (function () {
    function EditNurseComponent(userService, formBuilder, router) {
        this.userService = userService;
        this.formBuilder = formBuilder;
        this.router = router;
    }
    EditNurseComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    EditNurseComponent.prototype.editNurse = function () {
        var _this = this;
        var firstname;
        ...
        this.userService.profileNurseEdit(sessionStorage.getItem("NowUser"), firstname, lastname, this.editNurseForm.get('image').value, email, password, age, experience, years).subscribe(function (response) {
            _this.router.navigate(['/profileNurse']);
        }, function (error) {
            console.log('Error Posting in: ' + (error && error.message ? error.message : ''));
        });
    };
    return EditNurseComponent;
}());
EditNurseComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["o" /* Component */])({
        selector: 'app-profile-nurse-edit',
        template: __webpack_require__("../../../../../src/app/pages/profile-nurse-edit/profile-nurse-edit.component.html"),
        styles: [__webpack_require__("../../../../../src/app/pages/profile-nurse-edit/profile-nurse-edit.component.css")]
    }),
...
var _a, _b, _c;
//# sourceMappingURL=profile-nurse-edit.component.js.map

/***/ }),

/***/ "../../../../../src/app/pages/profile-nurse/profile-nurse.component.css":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../../../../src/app/pages/profile-nurse/profile-nurse.component.html":
/***/ (function(module, exports) {

module.exports = "<br>\n<br>\n<div class=\"container\">\n    <br>\n    <div id=\"centerbrand\">\n\n        <img id=\"brand\"  src=\"/assets/brand/brand.png\" width=\"170\" height=\"80\">\n    </div>\n\n    <h2 class=\"text-center\">Perfil</h2>\n    <br>\n        <tr *ngIf=\"profileNurse\">\n\n        <div>\n            <label>Username</label>\n            <p *ngIf=\"profileNurse\">{{profileNurse.username}}</p>\n            <label>Nombre</label>\n            <h1>{{profileNurse.firstname}}</h1>\n            <label>Apellido</label>\n            <h1>{{profileNurse.lastname}}</h1>\n            <label> Correo</label>\n            <h1>{{profileNurse.email}}</h1>\n            <label>Edad</label>\n            <h1>{{profileNurse.age}}</h1>\n            <label>Experience</label>\n            <h1>{{profileNurse.experience}}</h1>\n        </div>\n\n        </tr>\n\n        <a  routerLinkActive=\"/home\" routerLink=\"/home\"  class=\"btn btn-primary btn-lg active\" role=\"button\" aria-pressed=\"true\"> Home </a>\n        <a  routerLinkActive=\"/editNurse\" routerLink=\"/editNurse\"  class=\"btn btn-primary btn-lg active\" role=\"button\" aria-pressed=\"true\"> Edit </a>\n\n</div>\n"

/***/ }),

/***/ "../../../../../src/app/pages/profile-nurse/profile-nurse.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ProfileNurse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_forms__ = __webpack_require__("../../../forms/@angular/forms.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_users_service__ = __webpack_require__("../../../../../src/app/services/users.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__angular_router__ = __webpack_require__("../../../router/@angular/router.es5.js");
...
var ProfileNurse = (function () {
    function ProfileNurse(userService, formBuilder, router) {
        this.userService = userService;
        this.formBuilder = formBuilder;
        this.router = router;
    }
    ProfileNurse.prototype.ngOnInit = function () {
        var _this = this;
        var data = sessionStorage.getItem("NowUser");
        this.userService.profileNurse(data).subscribe(function (todosResponse) {
            _this.profileNurse = todosResponse;
...
ProfileNurse = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["o" /* Component */])({
        selector: 'app-profile-nurse',
        template: __webpack_require__("../../../../../src/app/pages/profile-nurse/profile-nurse.component.html"),
        styles: [__webpack_require__("../../../../../src/app/pages/profile-nurse/profile-nurse.component.css")]
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_2__services_users_service__["a" /* UsersService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__services_users_service__["a" /* UsersService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1__angular_forms__["a" /* FormBuilder */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_forms__["a" /* FormBuilder */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_3__angular_router__["a" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__angular_router__["a" /* Router */]) === "function" && _c || Object])
], ProfileNurse);

var _a, _b, _c;
//# sourceMappingURL=profile-nurse.component.js.map

/***/ }),

/***/ "../../../../../src/app/pages/profile-patient-edit/profile-patient-edit.component.css":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../../../../src/app/pages/profile-patient-edit/profile-patient-edit.component.html":
/***/ (function(module, exports) {

module.exports = "<br>\n<br>\n<div class=\"container\">\n    <br>\n    <div id=\"centerbrand\">\n\n        <img id=\"brand\"  src=\"/assets/brand/brand.png\" width=\"170\" height=\"80\">\n    </div>\n\n    <h2 class=\"text-center\">Perfil</h2>\n    <br>\n        \n    \n    <form [formGroup]=\"editPatientForm\" (ngSubmit)=\"editPatient()\" novalidate>\n    <tr *ngIf=\"profilePatient\">\n\n        <div>\n\n        <div class=\"form-group\">\n            <label><h4>Username:</h4> </label>\n            <p *ngIf=\"profilePatient\">{{profilePatient.username}}</p>\n        </div>\n        <div class=\"form-group\">\n            <label> <h4>Nombre:</h4></label>\n            <input id=\"firstname\" formControlName=\"firstname\" class=\"form-control\" value=\"{{profilePatient.firstname}}\"> <br>\n        </div>\n        <div class=\"form-group\">\n            <label><h4>Apellido:</h4></label>\n            <input id=\"lastname\" formControlName=\"lastname\" class=\"form-control\" value=\"{{profilePatient.lastname}}\"> <br>\n        </div>\n        <div class=\"form-group\">\n            <label> <h4>Correo:</h4></label>\n            <input id=\"email\" formControlName=\"email\" class=\"form-control\" value=\"{{profilePatient.email}}\"> <br>\n        </div>\n        <div class=\"form-group\">\n            <label><h4>Password:</h4></label>\n            <input id=\"password\" formControlName=\"password\"  class=\"form-control\" type=\"password\" value=\"{{profilePatient.password}}\"> <br>\n        </div>\n        <div class=\"form-group\">\n            <label><h4>Edad:</h4></label>\n            <input id=\"age\" formControlName=\"age\" class=\"form-control\" value=\"{{profilePatient.age}}\"> <br>\n        </div>\n        <div class=\"form-group\">\n            <label><h4>Numero tarjeta:</h4></label>\n            <input id=\"creditCardNumber\" formControlName=\"creditCardNumber\" class=\"form-control\" value=\"{{profilePatient.creditCardNumber}}\"> <br>\n        </div>\n        <div class=\"form-group\">\n            <label><h4>CVV:</h4></label>\n            <input id=\"creditCVV\" formControlName=\"creditCVV\" class=\"form-control\" value=\"{{profilePatient.creditCVV}}\"> <br>\n        </div>\n        </div>\n\n    </tr>\n    <button type=\"submit\" class=\"btn btn-success\" >Guardar</button>\n    </form>\n   \n</div>\n"

/***/ }),

/***/ "../../../../../src/app/pages/profile-patient-edit/profile-patient-edit.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var EditPatientComponent = (function () {
    function EditPatientComponent(userService, formBuilder, router) {
        this.userService = userService;
        this.formBuilder = formBuilder;
        this.router = router;
    }
    ...
    EditPatientComponent.prototype.editPatient = function () {
        ...
        this.userService.profilePatientEdit(sessionStorage.getItem("NowUser"), firstname, lastname, this.editPatientForm.get('image').value, email, password, age, creditCardNumber, creditCVV).subscribe(function (response) {
...
EditPatientComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["o" /* Component */])({
        ...
        template: __webpack_require__("../../../../../src/app/pages/profile-patient-edit/profile-patient-edit.component.html"),
        styles: [__webpack_require__("../../../../../src/app/pages/profile-patient-edit/profile-patient-edit.component.css")]
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_2__services_users_service__["a" /* UsersService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__services_users_service__["a" /* UsersService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1__angular_forms__["a" /* FormBuilder */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_forms__["a" /* FormBuilder */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_3__angular_router__["a" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__angular_router__["a" /* Router */]) === "function" && _c || Object])
], EditPatientComponent);

var _a, _b, _c;
//# sourceMappingURL=profile-patient-edit.component.js.map
...
module.exports = "<br>\n<h2  background=\"/assets/images/fondoblanco.png\">Solicitudes</h2>\n<table class=\"table\" background=\"/assets/images/fondoblanco.png\">\n    <thead>\n    <tr>\n        <th>Codigo</th>\n        <th>Fecha</th>\n        <th>Paciente</th>\n        <th>Enfermero/a</th>\n        <th>Descripción</th>\n        <th>Servicio</th>\n        <th>Aceptado</th>\n    </tr>\n    </thead>\n    <tr *ngFor=\"let request of requestlistTrue\">\n        <td>{{request.code}}</td>\n        <td>{{request.date}}</td>\n        <th>Nombre: {{request.patient.firstname}} {{request.patient.lastname}}<br>Correo: {{request.patient.email}}<br>Username: {{request.patient.username}}</th>\n        <th>{{request.nurse.firstname}} {{request.nurse.lastname}}</th>\n        <td>{{request.description}}</td>\n        <th>{{request.nursingservices.name}}: {{request.nursingservices.description}}</th>\n        <th bgcolor=\"#00FF00\">ACEPTADO</th>\n    </tr>\n\n    <tr *ngFor=\"let request of requestlistFalse\">\n        <td>{{request.code}}</td>\n        <td>{{request.date}}</td>\n        <th>Nombre: {{request.patient.firstname}} {{request.patient.lastname}}<br>Correo: {{request.patient.email}}<br>Username: {{request.patient.username}}</th>\n        <th>{{request.nurse.firstname}} {{request.nurse.lastname}}</th>\n        <td>{{request.description}}</td>\n        <th>{{request.nursingservices.name}}: {{request.nursingservices.description}}</th>\n        <th >PENDIENTE<a (click)=\"saveRequestCode(request.code)\" routerLinkActive=\"/requestsview\" routerLink=\"/requestsview\"  class=\"btn btn-primary btn-lg active\" role=\"button\" aria-pressed=\"true\">Revisar</a></th>\n    </tr>\n</table>\n\n"
...
var SignInPageComponent = (function () {
    function SignInPageComponent(formBuilder, usersService, router, appComponent) {
        ...
        this.signInForm = new __WEBPACK_IMPORTED_MODULE_2__angular_forms__["c" /* FormGroup */]({
            ...
            role: new __WEBPACK_IMPORTED_MODULE_2__angular_forms__["b" /* FormControl */]()
        });
    }
    ...
    SignInPageComponent.prototype.doLogin = function () {
        ...
        this.usersService.login(this.signInForm.get('username').value, this.signInForm.get('password').value).subscribe(function (loginResponse) {
            ...
            sessionStorage.setItem("Role", _this.signInForm.get("role").value);
...
var RequestService = (function (_super) {
    ...
    RequestService.prototype.createRequest = function (description) {
...
var UsersService = (function (_super) {
    ...
    UsersService.prototype.profileNurse = function (username) {
        return this.get(this.resourceNUrl + "/" + username);
    };
    UsersService.prototype.profilePatientEdit = function (username, firstname, lastname, image, email, password, age, creditCardNumber, creditCVV) {
        return this.post(this.resourceUrl + "/edit", new __WEBPACK_IMPORTED_MODULE_5__models_Patient__["a" /* Patient */](username, firstname, lastname, image, email, password, age, creditCardNumber, creditCVV));
    };
    UsersService.prototype.profileNurseEdit = function (username, firstname, lastname, image, email, password, age, experience, years) {
        return this.post(this.resourceNUrl + "/edit", new __WEBPACK_IMPORTED_MODULE_6__models_Nurse__["a" /* Nurse */](username, firstname, lastname, image, email, password, age, experience, years));
    };
    return UsersService;
